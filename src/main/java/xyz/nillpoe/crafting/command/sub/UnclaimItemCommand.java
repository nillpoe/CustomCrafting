...
public class UnclaimItemCommand implements SubCommand {
    ...
    public String getDescription() {
        return "손에 들고 있는 아이템을 조합법을 사용할 수 있는 권한이 제거되는 아이템으로 설정합니다.";
    }
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        NBT.modify(itemStack, (nbt) -> {
            nbt.setString("CUSTOM_CRAFTING_UNCLAIM", recipeId);
        });
